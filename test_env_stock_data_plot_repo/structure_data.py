...
class stockDataPlots:
    ...
    def getCurrentYahooData(self):
        ...
        incomeStatementQuarterly['Gross Margin'] = incomeStatementQuarterly['Gross Profit'] / incomeStatementQuarterly[
            'Total Revenue']
        incomeStatementQuarterly['Operating Margin'] = incomeStatementQuarterly['Operating Income'] / \
                                                       incomeStatementQuarterly['Total Revenue']
        incomeStatementQuarterly['Net Margin'] = incomeStatementQuarterly['Net Income'] / incomeStatementQuarterly[
            'Total Revenue']
        ...
        incomeStatementTTM = incomeStatementQuarterlyOrdered.drop('Date', axis=1).iloc[0:4, :].sum(axis=0, min_count=1,
                                                                                                   numeric_only=None)
        ...
        incomeStatementTTM['Operating Margin'] = incomeStatementTTM['Operating Income'] / incomeStatementTTM[
            'Total Revenue']
        ...
        balanceSheet['Total Non Current Liabilities'] = balanceSheet['Total Liab'] - balanceSheet[
            'Total Current Liabilities']
        ...
        balanceSheet['Adjusted Debt To Equity Ratio'] = balanceSheet['Total Liab'] / \
                                                        (balanceSheet['Total Stockholder Equity'] - balanceSheet[
                                                            'Good Will'])
        balanceSheet['Current Ratio'] = balanceSheet['Total Current Assets'] / balanceSheet['Total Current Liabilities']

        balanceSheetQuarterly['Total Non Current Assets'] = balanceSheetQuarterly['Total Assets'] - \
                                                            balanceSheetQuarterly['Total Current Assets']
        balanceSheetQuarterly['Total Non Current Liabilities'] = balanceSheetQuarterly['Total Liab'] - \
                                                                 balanceSheetQuarterly['Total Current Liabilities']
        balanceSheetQuarterly['Cash And Cash Equivalents'] = balanceSheetQuarterly['Cash'] + balanceSheetQuarterly[
            'Short Term Investments']
        balanceSheetQuarterly['Debt To Equity Ratio'] = balanceSheetQuarterly['Total Liab'] / balanceSheetQuarterly[
            'Total Stockholder Equity']
        balanceSheetQuarterly['Adjusted Debt To Equity Ratio'] = balanceSheetQuarterly['Total Liab'] / \
                                                                 (balanceSheetQuarterly['Total Stockholder Equity'] -
                                                                  balanceSheetQuarterly['Good Will'])
        balanceSheetQuarterly['Current Ratio'] = balanceSheetQuarterly['Total Current Assets'] / balanceSheetQuarterly[
            'Total Current Liabilities']
        ...
        cashflow['Operating Cashflow Ratio'] = cashflow['Total Cash From Operating Activities'] / self.incomeStatement[
            'Total Revenue']
        ...
        cashflowQuarterly['Operating Cashflow Ratio'] = cashflowQuarterly['Total Cash From Operating Activities'] / \
                                                        self.incomeStatementQuarterly['Total Revenue']
        cashflowQuarterly['Free Cashflow'] = cashflowQuarterly['Total Cash From Operating Activities'] + \
                                             cashflowQuarterly['Capital Expenditures']
        cashflowQuarterly['Free Cashflow Ratio'] = cashflowQuarterly['Free Cashflow'] / self.incomeStatementQuarterly[
            'Total Revenue']
        ...
        cashflowTTM = cashflowQuarterlyOrdered.drop('Date', axis=1).iloc[0:4, :].sum(axis=0, min_count=1,
                                                                                     numeric_only=None)
        ...
        cashflowTTM['Operating Cashflow Ratio'] = cashflowTTM['Operating Cashflow'] / self.incomeStatementTTM[
            'Total Revenue']
        ...
        usefulAttributes = ['_base_url',  # URL used for scraping
                            ...
                            '_tz',
                            # timezone (but more like city location). Seems to be needed for some functions like _options2df()
                            ...
                            'info',
                            # A massive load of information about the company like a business summary, number of employees, KPIs, PE-Ratio etc.
                            'institutional_holders',  # Top 10
                            'major_holders',  # Stock ownership in terms of Intitutions and Insiders
                            'mutualfund_holders',  # Top 10
                            'option_chain',
                            # represents data about the currently traded options. Is its own data-type created by yFinance
                            'quarterly_earnings',
        ...
        usefulAttributesNewNames = ['baseUrl',  # URL used for scraping
                                    ...
                                    'calendar',  # Future earnings date, seems to be somewhat flawed
                                    'dividends',
                                    # time series of dividend payments. Empty if no dividends have been payed
                                    'earnings',  # Just revenue and earnings for whole years (4 years)
    ...
    def updateLocalData(self,
                        path: str,
                        # Path to folder ending with '/' where folder of ticker is stored. Folders of tickers have to be named identical to the ticker.
